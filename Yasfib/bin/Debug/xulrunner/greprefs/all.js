...
pref("browser.display.auto_quality_min_font_size", 10);
...
pref("browser.download.useDownloadDir", false); // Whether or not to use the default download directory
pref("browser.download.folderList", 0); // Specify a folder list here (I'd just keep it at 0 if I were you)
pref("browser.download.manager.showAlertOnComplete", true); // Whether or not to display the "All downloads have been completed" message at the bottom right.
pref("browser.download.manager.showAlertInterval", 2000); // How long to show the message for, in milliseconds
pref("browser.download.manager.retention", 2); // Whether or not to keep finished downloads in the list (this is what you're looking for). Set to 2 if you DO want to keep them in the list
pref("browser.download.manager.showWhenStarting", true); // Whether or not to show the download dialog when a download starts.
pref("browser.download.manager.useWindow", true);
pref("browser.download.manager.closeWhenDone", false); // Automatically hide the window from the user when all downloads are finished.
pref("browser.download.manager.openDelay", 0);
pref("browser.download.manager.focusWhenStarting", true); // Auto-focus the download window when a download starts.
